    ...
    <div class="col-md-6">
      <ul>
        <li ng-repeat="slide in slides">
          <button class="btn btn-default btn-xs" ng-class="{'btn-info': !slide.active, 'btn-success': slide.active}" ng-disabled="slide.active" ng-click="slide.active = true">select</button>
          {{$index}}: {{slide.text}}
        </li>
      </ul>
...
.directive( 'datepicker', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
  return {
    ...
    link: function(scope, element, attrs, ctrls) {
      ...
      //add by zhunian
      if (attrs.airtimeMin) {
          scope.$parent.$watch($parse(attrs.airtimeMin), function(value) {
            datepickerCtrl.airtimeMin = value ? new Date(value) : null;
            refill();
          });
        }
      ...
      if (attrs.airtimeMax) {
          ...
          scope.$parent.$watch($parse(attrs.airtimeMax), function(value) {
            datepickerCtrl.airtimeMax = value ? new Date(value) : null;
            refill();
          });
        }
      
      if (attrs.seatimeMin) {
            scope.$parent.$watch($parse(attrs.seatimeMin), function(value) {
              datepickerCtrl.seatimeMin = value ? new Date(value) : null;
              refill();
            });
        }
      if (attrs.seatimeMax) {
            scope.$parent.$watch($parse(attrs.seatimeMax), function(value) {
              datepickerCtrl.seatimeMax = value ? new Date(value) : null;
              refill();
            });
        }
      //add end
      ...
      function refill( updateSelected ) {
        ...
        if ( ngModel.$modelValue ) {
          ...
          {	
        	  ...
        	  if(dateWithTimeRe.test(ngModel.$modelValue))
        	  {
        		  var arr =dateWithTimeRe.exec(ngModel.$modelValue); 
        		  date=new Date(parseInt(arr[1]),parseInt(arr[2])-1,parseInt(arr[3]));        		  
        	  }
        	  else if(dateWithoutTimeRe.test(ngModel.$modelValue))
              {
        		  var arr =dateWithoutTimeRe.exec(ngModel.$modelValue);
        		  date=new Date(parseInt(arr[1]),parseInt(arr[2])-1,parseInt(arr[3]));  
              }
          }
          //add end
        ...
        angular.forEach(data.objects, function(obj) {
          ...
          //add by zhunian
          if(datepickerCtrl.airtimeMax && datepickerCtrl.airtimeMin)
          {
        	  if(datepickerCtrl.airtimeMax.getTime()-obj.date.getTime()>=0 && datepickerCtrl.airtimeMin.getTime()-obj.date.getTime()<=0)
        	  {
        		  obj.inAirTime=true; 
        	  }
          }
          ...
          if(datepickerCtrl.seatimeMax && datepickerCtrl.seatimeMin)
          {
        	  
        	  if(!obj.inAirTime && datepickerCtrl.seatimeMax.getTime()-obj.date.getTime()>=0 && datepickerCtrl.seatimeMin.getTime()-obj.date.getTime()<=0)
        	  {
        		  obj.inSeaTime=true; 
        	  }
          }
  ...
  return {
    ...
    link: function(originalScope, element, attrs, ngModel) {
     ...
     // create a child scope for the datepicker directive so we are not polluting original scope
      ...
      //add by zhunian
      addWatchableAttribute(attrs.airtimeMin, 'airtimeMin','airtime-min');
      addWatchableAttribute(attrs.airtimeMax, 'airtimeMax','airtime-max');    
      addWatchableAttribute(attrs.seatimeMin, 'seatimeMin','seatime-min');
      addWatchableAttribute(attrs.seatimeMax, 'seatimeMax','seatime-max');
...
<example module="ui.bootstrap">
  <file name="index.html">
    <tabset>
      ...
      <tab>
        <tab-heading><i class="glyphicon glyphicon-heart"></i> Icon heading?!?</tab-heading>
        That's right.
      </tab>
    </tabset>
  </file>
...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/datepicker.html",
    ...
    "      <th><button type=\"button\" class=\"btn btn-default pull-left\" ng-click=\"move(-1)\"><i class=\"glyphicon glyphicon-chevron-left\"></i></button></th>\n" +
    ...
    "      <th><button type=\"button\" class=\"btn btn-default pull-right\" ng-click=\"move(1)\"><i class=\"glyphicon glyphicon-chevron-right\"></i></button></th>\n" +
    "    </tr>\n" +
    ...
    "        <button type=\"button\" style=\"width:100%;\" class=\"btn btn-default\" ng-class=\"{'btn-info': dt.selected,'btn-primary': dt.inSeaTime,'btn-warning': dt.inAirTime}\" ng-click=\"select(dt.date)\" ng-disabled=\"dt.disabled\"><span ng-class=\"{muted: dt.secondary}\">{{dt.label}}</span></button>\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
...
angular.module("template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/popup.html",
    ...
    "			<button class=\"btn btn-default btn-sm btn-inverse\" ng-click=\"today()\">Today</button>\n" +
    "			<button class=\"btn btn-default btn-sm btn-info\" ng-click=\"showWeeks = ! showWeeks\" ng-class=\"{active: showWeeks}\">Weeks</button>\n" +
    "			<button class=\"btn btn-default btn-sm btn-danger\" ng-click=\"clear()\">Clear</button>\n" +
    "		</span>\n" +
    "		<button class=\"btn btn-default btn-sm btn-success pull-right\" ng-click=\"isOpen = false\">Close</button>\n" +
    "	</li>\n" +
    "</ul>");
}]);
...
angular.module("template/dialog/message.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/dialog/message.html",
    ...
    "	<button ng-repeat=\"btn btn-default in buttons\" ng-click=\"close(btn.result)\" class=\"btn btn-default\" ng-class=\"btn.cssClass\">{{ btn.label }}</button>\n" +
    "</div>\n" +
    "");
}]);
...
angular.module("template/timepicker/timepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/timepicker/timepicker.html",
    ...
    "	<tr class=\"text-center\">\n" +
    "		<td><a ng-click=\"incrementHours()\" class=\"btn btn-default btn-link\"><i class=\"glyphicon glyphicon-chevron-up\"></i></a></td>\n" +
    "		<td>&nbsp;</td>\n" +
    "		<td><a ng-click=\"incrementMinutes()\" class=\"btn btn-default btn-link\"><i class=\"glyphicon glyphicon-chevron-up\"></i></a></td>\n" +
    ...
    "	</tr>\n" +
    "	<tr class=\"text-center\">\n" +
    "		<td><a ng-click=\"decrementHours()\" class=\"btn btn-default btn-link\"><i class=\"glyphicon glyphicon-chevron-down\"></i></a></td>\n" +
    "		<td>&nbsp;</td>\n" +
    "		<td><a ng-click=\"decrementMinutes()\" class=\"btn btn-default btn-link\"><i class=\"glyphicon glyphicon-chevron-down\"></i></a></td>\n" +
    "		<td ng-show=\"showMeridian\"></td>\n" +
    "	</tr>\n" +
    "</table>");
}]);
