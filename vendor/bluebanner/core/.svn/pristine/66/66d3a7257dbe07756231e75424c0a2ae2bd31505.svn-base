...
class RequestService implements RequestServiceInterface {
  ...
  public function dtm() {
	...
	{
	    $allowFields=array('id', 'agent', 'agent_name', 'platform_id', 'warehouse_id', 'warehouse_name', 'invoice', 'check_note','status',  'type', 'note','relation_id', 'verified_note','created_at','updated_at','expired_at');
	    $tmp=array();
	 ...
	 * @return 		string
     */
    public function GenerateInvoice($platform_id = 0)
    {
        return PurchaseRequest::GenerateInvoice($platform_id);
    }
    ...
    public function createMaster(array $pr)
    {
        ...
        $attrs['platform_id'] = $pr['platform_id'];
